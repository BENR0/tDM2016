...
```{r gmm verification statistik test, echo = FALSE,fig.cap = figNum("Chi-Quadrat-Test. Nullhypothese: Daten und GMM besitzen die gleiche Verteilung")}
...
```{r GMM plot_Precip, echo = FALSE,fig.cap = figNum("GMM für tranformierte Precipitation Daten ohne 0,0 und 0,1, 3 Gauss")}
Werte2 <- list(Means = c(126.0190, 429.6519, 712.7960), 
           SDs = c(121.8712, 122.5664, 135.4684), 
           Weights = c( 0.343, 0.224, 0.553))
