...
```{r load_packages_jiachun, echo=FALSE, error=FALSE, message=FALSE, include=FALSE, eval = FALSE}
#load packages
packages <- c('ABCanalysis','AdaptGauss','DataVisualisation','dbt.attributes','dbt.BDM','dbt.CART'
              ,'dbt.ClassAnalysis','dbt.classifiers','dbt.ColorScale','dbt.ColorScale','DataIO',
