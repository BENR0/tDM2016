...
```{r FFT_Benj, echo = FALSE, eval = TRUE, fig.cap = figNum("GMM Verifizierung, QQplot gegen Normalverteilung")}
...
Im Spektrum des Strahlungs Datensatzes zeigt sich das neben der vermuteten
dijurnalen Schwankung (Peak bei einer Frequenz von ca. 0.00002) weitere prägnante
Frequenzpeaks auffallen. Diese könnten mit regionalen klimatischen Bedingungen,
beispielsweise ausgeprägtem Tagesgang mit Niederschlägen zusammenhängen. Dies ist
ohne weitere Hinweise durch entsprechende Experten nicht zu beurteilen.
...
```{r umatrix, echo = FALSE, eval = TRUE, message = FALSE, include = FALSE}
...
```{r HMM_Multivariate, echo = FALSE, eval = TRUE, message = FALSE, include = FALSE}
...
```{r HMM_Multivariate_summary, echo = FALSE, eval = TRUE, message = FALSE}
print(HMMfit3)
summary(HMMfit3)
```
