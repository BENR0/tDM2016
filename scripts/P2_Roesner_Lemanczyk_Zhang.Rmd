...
```{r sqrt, echo = FALSE, fig.cap = "Inspect data", anchor = "figure", eval = eval_block}
...
```{r 6th root, echo = FALSE, fig.cap = "Inspect data", anchor = "figure", eval = eval_block}
sixthroot <- zooRad^(1/6)
overviewPlot(coredata(sixthroot))
```

```{r GMM, echo = FALSE, fig.cap = "Inspect data", anchor = "figure", eval = eval_block}
...
```{r QQ_GMM, echo = FALSE, fig.cap = "Inspect data", anchor = "figure", eval = eval_block}
...
```{r FFT, echo = FALSE, fig.cap = "Inspect data", anchor = "figure", eval = eval_block}
...
```{r , echo = FALSE, fig.cap = "Inspect data", anchor = "figure", eval = eval_block}
