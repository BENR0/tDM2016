...
packages <- c(packages, "tidyr", "dplyr", "lubridate", "zoo", "stringr", "timeSeries",  "car", "forecast", "dbt.RetroMAT", "RHmm",  "depmixS4")  # from Benjamin
...
```{r Benjamin Radiation data, child = "P2_Radiation.Rmd", eval=eval_block}
```
